...
var datos ={
    ...
    "Walt’s pre-Heisenberg vehicle, the one he runs over the gangsters in, is a"],
     answers:["Hannah Montana","iCarly", "Victorious", "Disney Club",
      "Harbor School","Beverly High","Bayview School","Orange High",
      "Britney Spears","Beyonce","Pink","Avril Lavigne",
      "Dawson","Charlie","Pacey","Jack",
        "Trumpet","Tuba","French Horn","Clarinet",
        ...
        "A basilik fang","The sword of gryffindor","Fiendfyre","The killing curse",
        "Saurumon's forces versus King Theoden Rohrrimn", "Saurumon's forces versus the Ents","Orcs versus Galadhrim of Lothlorien", "Sauron forces versus Gondor forces",
        "You were right about me, tell your sister you were right","I'm sorry","May the force be with you","You are the last jedi, the force runs strong in you, pass on.. what you have learned",
        "Chevy Citation","Ford Explorer","Nissan Cube","1Pontiac Aztek"],
     results:[2,0,3,2,2,3,2,0,1,0,3],
